                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="input-group input-group-static m-2">
                                    <label for="title1">Slider Title 1 *</label>
                                    <input class="form-control" type="text" name="title1" id="title1" value="<?= $slider['title1'] ?>" required>
                                </div>
                            </div>
                            <!--<div class="col-12 col-sm-6">
                                <div class="input-group input-group-static m-2">
                                    <label for="title2">Slider Title 2 *</label>
                                    <input class="form-control" type="text" name="title2" id="title2" value="<?= $slider['title2'] ?>" required>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12">
                                <div class="input-group input-group-static m-2">
                                    <label for="paragraph">Slider Paragraph *</label>
                                    <input class="form-control" type="text" name="paragraph" id="paragraph" value="<?= $slider['paragraph'] ?>"  required>
                                </div>
                            </div> -->
                            <!--<div class="col-12 col-sm-6">
                                <div class="input-group input-group-static m-2">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class="form-control" type="text" name="url" id="url" value="<?= $slider['url'] ?>" required>
                                </div>
                            </div> -->
                            <div class="col-12 col-sm-6">
