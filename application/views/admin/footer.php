<!--   Core JS Files   -->
  ...
  <script src="<?php echo base_url('/assets/admin/js/plugins/choices.min.js'); ?>"></script>
  ...
  <script src="<?php echo base_url('/assets/admin/js/plugins/multistep-form.js'); ?>"></script>
  <script src="<?php echo base_url('/assets/admin/js/plugins/chartjs.min.js'); ?>"></script>
  <script src="<?php echo base_url('/assets/admin/js/plugins/datatables.js'); ?>"></script>
  <script>
  ...
  <!-- Kanban scripts -->
  <script src="<?php echo base_url('/assets/admin/js/plugins/dragula/dragula.min.js'); ?>"></script>
  <script src="<?php echo base_url('/assets/admin/js/plugins/jkanban/jkanban.js'); ?>"></script>
  <script>
  ...
  <script src="<?php echo base_url('/assets/admin/js/material-dashboard.min.js?v=3.0.5'); ?>"></script>
</body>
