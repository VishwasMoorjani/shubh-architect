...
<head>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="<?php echo base_url('assets/admin/css/material-dashboard.css?v=3.0.4');?>" rel="stylesheet" />
</head>
...
<body class="">
        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div id="signup" class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('<?php echo base_url('assets/admin/img/illustrations/illustration-signup.jpg');?>'); background-size: cover;">
              </div>
            </div>
  ...
  <script src="<?php echo base_url('assets/admin/js/material-dashboard.min.js?v=3.0.4');?>"></script>
</body>
