          ...
          <div class="d-lg-flex">
            ...
            <div class="ms-auto my-auto mt-lg-0 mt-4">
              <div class="ms-auto my-auto">
                <a href="addgallery" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Gallery</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <?php foreach ($sliders as $slider) { ?>
                  <tr>
                    ...
                    <td class="align-middle">
                      <a href="<?= base_url('admin/editgallery/' . $slider['link']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
