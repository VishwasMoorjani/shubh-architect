                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <?php if ($review['status'] == 1) { ?>
                        <a href="<?= base_url('admin/deactivate/reviews/' . $review['id']); ?>"><span class="badge badge-sm bg-gradient-success">Active</span></a>
                      <?php } elseif ($review['status'] == 0) { ?>
                        <a href="<?= base_url('admin/activate/reviews/' . $review['id']); ?>"><span class="badge badge-sm bg-gradient-secondary">Deactive</span></a>
                      <?php } ?>
                    </td>
                    ...
                    <td class="align-middle">
                      <a href="<?= base_url('admin/editreviews/' . $review['id']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                        <i class="fas fa-edit"></i>Edit
                      </a>&nbsp;
                      <a href="<?= base_url('admin/delete/reviews/' . $review['id']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
