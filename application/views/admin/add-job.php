    ...
    <div class="card">
        <div class="card-header p-0 position-relative mt-n5 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <center>
                    <h5 class="font-weight-bolder text-white">Job Information</h5>
                </center>
            </div>
        </div>
        <div class="card-body">
            <form class="multisteps-form__form" method="post" action="addjob" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class="form-control" type="text" name="employment" id="employment" required>
                                </div>
                            </div>
                        </div>
