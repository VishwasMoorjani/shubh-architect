    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?= base_url(); ?>" target="_blank">
                <img src="<?= base_url(logo); ?>" style="max-height: 50px;" alt="" srcset="">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link text-white" href="<?= base_url('admin/plans'); ?>">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link text-white" href="<?= base_url('admin/process'); ?>">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-file" aria-hidden="true"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?= base_url('admin/services'); ?>">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="<?= base_url('admin/enquiry'); ?>">
                        ...
                        <span class="nav-link-text ms-1">Service Enquiry</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item ">
                    ...
                    <div class="collapse " id="ordersExample">
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a class="nav-link text-white " href="<?= base_url('admin/whychoose'); ?>">
                                    <span class="sidenav-normal  ms-2  ps-1"> Why Choose Us </span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky noPrint" id="navbarBlur" data-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <img src="<?= base_url(logo); ?>" style="height:3rem" alt="" srcset="">
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar" style="justify-content: end;">
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="<?php echo site_url('admin/logout') ?>" class="nav-link text-body font-weight-bold px-0">
                        ...
                        <li class="nav-item px-3 d-flex align-items-center">
                            <a href="<?php echo site_url('admin/globalsettings') ?>" class="nav-link text-body p-0">
                        ...
                        <!--                <div class="d-flex py-1">-->
                        <!--                    <div class="my-auto">-->
                        <!--                        <img src="<?php echo base_url('assets/admin/img/small-logos/logo-spotify.svg'); ?>" class="avatar avatar-sm bg-gradient-dark  me-3 ">-->
                        <!--                    </div>-->
                        <!--                    <div class="d-flex flex-column justify-content-center">-->
                        <!--                        <h6 class="text-sm font-weight-normal mb-1">-->
